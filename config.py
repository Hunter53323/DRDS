...
class ConfigGenerate:
    ...
    """
    def __init__(self, seed:int = 0, device_number:int = 15, server_number:int = 9, application_number:int = 15, microservice_number:int = 30, start_mode:str = "running", end_time:int = 40):
        self.config = {}
        random.seed(seed)
    ...
    def generate_application(self):
        ...
        for i in range(self.application_number):
            ...
            for j in range(len(application_dict['ms_id_list']) - 1):
                application_dict['message'].append({"data": random.randint(50, 500), "sender": application_dict['ms_id_list'][j], "receiver": application_dict['ms_id_list'][j+1]})
    ...
    def generate_movement(self):
        ...
        movement_time_list = list(range(1,self.end_time))
...
def get_config(seed:int = 0, device_number:int = 15, server_number:int = 9, application_number:int = 15, microservice_number:int = 30, start_mode:str = "running", end_time:int = 40):
    """
    生成配置文件
    """
